...

{
  ...
  programs.bash = {
    ...
    shellAliases = {
      ...
      qwen36mtp = "llama-server -m /mnt/hdd/models/qwen3.6-27b-mtp/Qwen3.6-27B-UD-Q3_K_XL.gguf --host 127.0.0.1 --port 8080 -ngl 99 -fa on -c 196608 --cache-type-k q4_0 --cache-type-v q4_0 --threads 12 --jinja --alias qwen3.6-27b-mtp-q3kxl --spec-type draft-mtp --spec-draft-n-max 2";
    };
  };
